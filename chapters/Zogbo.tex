...
\downingdouble{/ɔ$^2$ bi$^2$bie$^2$ ɔ$^2$/ }{‘he begs him’ (person)}

\downingdouble{bibiǿ ɔ }{(vowel elision) }

\downingdouble{[ɔ bibi o] }{(\isi{vowel harmony})}



\section{More elaborate systems}\label{sec:zogbo:2} 

Though both Western and Eastern \ili{Kru} attest the standard 9 oral vowel system, several Eastern \ili{Kru} languages (and Western \ili{Bakwé}) have much larger phonemic vowel inventories, with many additional central (or back unrounded) phonemic vowels\footnote{Researchers have used both terms.  Central vowels in \ili{Kru} are not rounded. In acoustic studies, \citet{grégoire1972} has called these vowels in \ili{Bété} of \ili{Guibéroua} \textit{central} \citep[see also][15]{Zogbo1981}. In other descriptions, \citet[61]{Werle1976} as well as \citet[7]{kipre2005} analyze them as \textit{back unrounded.} In Goprou’s more recent study of \ili{Kpɔkolo}, a \ili{Bété} dialect (\citeyear{Goprou2010}; \citeyear[177]{Goprou2014}), findings are somewhat skewed. For vowels [ɨ, $\theta $, ʌ, and a], a female speaker shows F2 readings around 1500 Hz, indicating a clear central position, while [$\theta $] positions itself as a back rounded vowels (under 1500 Hz), as does [ʌ] in male speakers. This issue is important but out of the \isi{scope} of this paper.} , as seen below:
...
Curiously, though \ili{Gbadi} is classified as \ili{Bété}, with the exception of /a/, it attests no central vowels (C. Goprou, p.c.\& H.Tebili, word list), underlining the issue of frequent mismatches between ethnic/social perceptions and linguistic classifications. 
...
Note that examples of proto back vowels *u, *o, and *ɔ giving a central reflex are rare.  One example might be PEK *ɓlo ‘one’ $\rightarrow$ ɓlʉ  (\ili{Godié}, jlʉkɔ dialect). Cases of low vowels *Ɛ and *ɔ giving a central vowel are equally rare.
...
% biblio entries added

\begin{comment}
\begin{verbatim}
Ahoua, F \& B. Elugbe. 2017. \textit{Language Typology and Language Documentation in West Africa}, Paris : Harmattan. 

Associaton Gwëjekʊmӧ. 2004. \textit{Petit dictionnaire godié, A sa gwëje zɔɔ}!, Abidjan: SIL. 

Bentinck, Julie. 1978. \textit{Etude phonologique du niaboua}, Abidjan: Publications conjointes ILA-SIL, 1978, Vol. 3.

\textit{Bakʋɛwaklüüa --Pɔɔkʋ}. 2006.  (Edition préliminaire). Méagui:~Centre de Traduction et d'Alphabétisation en langue \ili{Bakwé}.~

Bogny, Joseph, “Typological features template for Attie”, https://typecraft.org/tc2wiki/Typological\_Features\_Template\_for\_Attie.

Casali, Roderic F. 2008. “ATR Harmony in African Languages”, \textit{Language and Linguistics Compass} 2/3, 496–549. 

Dimmendaal, Gerrit, 2001.  “Areal Diffusion versus Genetic Inheritance: An African Perspective”. 

Egner, I. 1989. \textit{Précis de grammaire wobé}, Annales de linguistique, tome XV, Abidjan 
«~Exposé historique sur le peuple bakwé de l’émission radiophonique ‘au cœur de la Côte d’Ivoire’ de Jules Koffi Yeboua~», 2013. Méagui:~Centre de Traduction et d'Alphabétisation en langue \ili{Bakwé}.~

Goprou, Djaki Carlos. 2010. \textit{Etude phonétique et phonologique du kpɔ}\textit{kolo, parler \ili{Bété} de Gagnoa}, doctoral thesis, Université de Cocody, Abidjan. 

Goprou, Djaki Carlos. 2014. “Les voyelles centrales en kpɔkolo”, \textit{Cahiers d’Etudes linguistiques}, Numéro 8. 

Gratrix, Carol, 1975, “Morphotonologie du godié”, \textit{Annales de l’Université d’Abidjan}, Série H, Abidjan: ILA.  

Gnahore, Dali Laure Inès, 2005-6, \textit{Essai sur le système verbal du gaɓʊgbʊ}, MA thesis, Université~ d’Abidjan.

Guehoun, M. Augustin. 1993. \textit{Description systématique du dida de Lakota}, doctoral thesis, Université Stendhal de Grenoble.

Grégoire, H-C. 1972. \textit{Etude acoustique du système vocalique du bete (région de \ili{Guibéroua}).}  Abidjan: ILA.  

Heine, Bernd and Derek Nurse. 2000. \textit{African Languages, an Introduction}. Cambridge University Press. 

Hickey, Raymond. MS. “Vowels before r in the history of \ili{English}”, 

https://www.uni-due.de/{\textasciitilde}lan300/Vowels\_before\_R\_(Hickey).pdf.

Kaye, Jonthan, 1980. “The mystery of the tenth vowel”, \textit{Journal of Linguistic Research}, Vol 1, 1-14.  

Kipre, Blé François. 2015. “Interprétation phonologique des structures syllabiques CVlV et CWV du \ili{Bété} revisitée”, \textit{Afrique, Langue et Cultures}, Numéro 5. 

Kipre, Pierre.  2005. \textit{Côte d'Ivoire : la formation d'un peuple}, Paris : Éd. SIDES-IMA,

Kokora, Dago Pascal. 1976. \textit{Studies in the Grammar of Koyo}, doctoral thesis, University of Indiana.

Kutsch Lojenga, C. et E. Hood. 1982. “L’Attié”, \textit{Atlas des langues kwa de Cote d’Ivoire}, Tome 1, éd. Hérault, Abidjan : ILA, pp. 227-253.  

Lafage, Philippe, 1978, \textit{Les langues kru,} in IEL.

Lafage, Suzanne, 1983, \textit{Etude sociolinguistique de l’aire kru de Côte d’Ivoire}, Abidjan : ACCT-ILA, 2\textsuperscript{e} édition. 

Lewis, et. al. 2014.  \textit{Ethnologue}.  SIL. 

Lynch, John, 2015, “The Phonological History of \ili{Iaai}”, in \textit{Languages and Linguistics in Melanesia}, Vol 33, No. 1, 2-15. 

Marchese, Lynell. 1975. «~Morphophonologie du verbe godié~», \textit{Annales de l'Université d'Abidjan}. Série H, Fasc. 1, pp. 215-239. 

Marchese, Lynell.   1979/1983. \textit{Atlas linguistique des langues kru: essai de typologie}. ILA, Université d'Abidjan, vol. LXXIII.

Marchese, Lynell. 1986. \textit{Tense/\isi{aspect} and the Development of Auxiliaries in the \ili{Kru} Language Family}, SIL-University of Texas Press, Arlington. 

Marchese, Lynell. 1988.  'Noun Classes and agreement systems in \ili{Kru}: A Historical Approach', in \textit{Agreement in natural language: Approach, theories and descriptions}. Barlow and Ferguson (eds.), Stanford University Press.

Marchese, Lynell. 1989.  '\ili{Kru}', in \textit{The Niger-Congo Languages}, Bendor Samuel (ed.), Lanham: University Press of America, Inc.- SIL, pp. 119-139.

Morton, Deborah. 2012.  “[ATR] Harmony in an 11 Vowel Language: the Case of \ili{Anii}” in Marlo, Michael R., Nikki B. Adams, Christopher R. Green, Michelle Morrison, and Tristan M Purvis (eds.) \textit{Selected Proceeding of the 42\textsuperscript{nd}} \textit{Annual Conference on African Linguistics}{}-.Somerville, MA: Cascadilla Proceedings. 

Paradis, Carole «~La règle d’élision syllabique et les séquences vocaliques en guere~», pp. 181-193. 

Rolle, Nicholas. 2013. “Nasal vowel patterns in West Africa”, UC Berkeley Phonology lab report. 

Saunders, Philip. 2009. \textit{Encountering \ili{Kouya}:  A study of the key phonological, syntactic and discourse properties of an endangered \ili{Kru} language}, Phd dissertation, University of Ulster at Jordanstown.

Seri Guezé Martine, 1987, \textit{Système nominal du Gbaw}ʌ\textit{lɪ} (sous groupe bété). D.E.A, Université d’Abidjan. 

Singler, John Victor, 1979, \textit{The Segmental Phonology of Verb Suffixes in Talo Kalo (\ili{Kru})}, MA thesis, UCLA.

Tebili, Hortense. 2010. «~Esquisse phonologique du digbʊ, parler \ili{Bété} de \ili{Guibéroua}~». MA thesis, UCLA.

Vahoua, Kallet A. 2011. “L’instabilité de la Voyelle /   /  dans un Parler \ili{Bete} Langue kru de Cote D’ivoire~» \textit{Nordic Jouranl of African Studies.} 20 (2), pp. 150-176.                          

Vydrine, Valentin. 2004. “Areal and genetic features in West \ili{Mande} and South \ili{Mande} phonology: In what sense did \ili{Mande} languages evolve?” \textit{Journal of West African Languages,} vol. XXX, \# 2, pp. 113-125.  

Vydrine, Valentin. 2009. “Areal features in South \ili{Mande} and \ili{Kru} languages”, Cyffer N. and Ziegelmeyer, \textit{When languages meet: Language contact and change in West Africa}, Köln: Rüdiger Köppe Verlag, pp. 91-116.

Vydrine, Valentin. 2013. “\ili{Goo} : présentation d’une langue”, INALCO – LLACAN, CNRS UMR 8135.

Vydrine, Valentin et Mongnan Alphonse Kességbeu. 2008. \textit{Dictionnaire \ili{Dan}-Français (dan de l'Est) avec une esquisse de grammaire du dan de l'Est et un index français-dan.} St Pétersbourg: Nestor-Istoria, 

Werle, Johannes-Martin et Dagou Justin Gbalehi. 1976. \textit{Phonologie et morphonologie du bété de la région de Guibéroua}.  Abidjan : Publications conjointes ILA-SIL. 

Welmers, Wm. E. 1973. \textit{African Language Structures}. Berkeley: University of California Press. 

Williamson, K and R. Blench. 2000, “Niger Congo” in Heine and Nurse, p. 11-42. 

Zogbo, Gnoléba Raymond, 2005. \textit{Dictionnaire \ili{Bété}-Français}, Abidjan : CERAP. 

Zogbo, Lynell, 2011, 'Les langues kru', ‘Le bété’, \textit{Dictionnaire des langues}, Bonvini, Busuttil, Peyraude, eds., Paris: PUF, pp.  44-57.

Zogbo, Lynell. 2017. «~Les vestiges de classes nominales dans les langues kru : accord et suffixes~», in Ahoua \& Elugbe, 2017, pp. 241-262. 
