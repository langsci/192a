...
Within these systems, central vowels follow the rules of \isi{vowel harmony}, with typical +ATR word-internal constraints, illustrated for Guibéroua Bété in \tabref{tab:zogbo:8} and Gbawale in \tabref{tab:zogbo:8}.
...
\begin{table}
\todo[inline]{ʊ instead of ʊ?}
\todo[inline]{ɤ instead of ɤ?}
\begin{tabular}{ccc}
i  &  ɨ (ɯ) &   u\\
...
\begin{table}
\todo[inline]{ɵ instead of theta?}
\todo[inline]{ʌ in weird position. Maybe ɐ?}
\todo[inline]{ʊ instead of ʊ?}
