...
\ea \ili{Guibéroua} \ili{Bété} \citep{Werle1976}
...
\begin{table}
\todo[inline]{table needs reference in text}
...
The adjective ‘new’ appears to be inherently +ATR and agrees with the noun it modifies (lolo, lala, lələ, \tabref{tab:zogbo:7}).
...
Within these systems, central vowels follow the rules of \isi{vowel harmony}, with typical +ATR word-internal constraints \tabref{tab:zogbo:8}.
...
As in most of these languages, /a/ occurs with both series (\tabref{tab:zogbo:10}). 
...
\begin{table}
\todo[inline]{ʊ instead of ʋ?}
\todo[inline]{ɤ instead of ɣ?}
\begin{tabular}{ccc}
i  &  ɨ (ɯ) &   u\\
