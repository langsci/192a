...
In addition to the prefixed Subj-CA pattern discussed above, \ili{Kipsigis} declarative-embedding complementizers can also agree with the matrix object, with a suffixed agreement morpheme (Obj-CA): we give the agreement paradigm in Table \ref{Obj CA Forms Table}. 
