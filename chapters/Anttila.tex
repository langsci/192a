...
\ChapterDOI{10.5281/zenodo.3367122}
...
%
%        [b     a :   ʊ]     phonetics
\begin{forest} for tree={s sep=5mm}
[,phantom
    [$\omega$ [$\varphi$ [$\sigma$,calign=child,calign child=2 [b,tier=melody [$\big{[}\text{b}$,no edge]] [$\mu$ [a,xshift=4.5mm,name=a [aː,no edge,xshift=4.5mm]] ] [$\mu$,name=mu2] ] ] ]
    [$\sigma$,tier=syllable [$\mu$ [ʊ [$\text{ʊ}\big{]}$] ] ] ]
    [word [foot [syllable,tier=syllable [mora,tier=mora [melody,tier=melody [phonetics,tier=phonetics] ] ] ] ] ]
]
...
\begin{forest}
[,phantom
    [$\omega$ [$\varphi$ [$\sigma$ [b,tier=melody [$\big{[}\text{b}$, no edge]] [$\mu$,tier=mora [a [a, no edge] ] ] ] [$\sigma$ [r,tier=melody [r, no edge]] [$\mu$ [ʊ [ʊ,no edge] ] ] ] ] ]
    [$\sigma$,tier=syllable [$\mu$ [ʊ [\phantom{ʊ}$\text{ː}\big{]}$, no edge] ] ] ]
    [word [foot [syllable,tier=syllable [mora [melody,tier=melody [phonetics] ] ] ] ] ]
]
\end{forest}
\z
