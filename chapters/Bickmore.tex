...
\ea\label{ex:bickmore:8}
  Assuming /r/ to be under\rephrase{ling}{lying}    \\ 
  \phonrule{r}{l}{
  $\left\{
  \begin{tabular}{l}
  {\db}\#\\{}
...
\ea\label{ex:bickmore:9}
  Assuming /l/ to be under\rephrase{ling}{lying} \\
  \phonrule{l}{r}{
  $\left\{
  \begin{tabular}{l}
  [--bk]{\longrule}\\
...
\ea\label{ex:bickmore:17}\todo{what is the scope of --hi? Does it belong to the left V or to the right V?}
Vowel Deletion%
...
Under the /l/ analysis, the UR of \REF{ex:bickmore:21} would be /ku-zool-a e-bi-tabu/. The structural description of the l→r rule is met at the level of the word as the /l/ is followed by a [+back] vowel, yielding: ku-zoor-a e-bi-tabu.\todo{should this be in italics?} 
Vowel deletion would apply at the phrase level, producing the ungrammatical *ku-zoor ee-bi-tabu \todo{should this be in italics?} 
