...
All derived verbs have Grade 2 stem vowels.\footnote{With the exception of the class of intransitives mentioned in fn. \ref{fn:monich:5}.} \tabref{tab:monich:12} illustrates the correspondence between basic transitive verbs with Grade A stem vowels and derived verbs with Grade 2 vowels.
...
\midrule
Class I & bṳ̀lɛ̂ & bɔ̤̀lɛ̂ & `roast' & tè̤dɛ̂ & tèdɛ̂ & `dig' & cjè̤ŋɛ̂ & cjèŋɛ̂ & `live' \\
Class II & ně̤nɛ̂ & něnɛ̂ & `see' & mʌ̤́d̪ɛ̀ & má̤d̪ɛ̀ `drink' & wṳ́rɛ̀ & wɔ̤́rɛ̀ & `run' \\
\lspbottomrule
\end{tabularx}
...
\midrule
A & B & A & B & ‘big river’ & kîir & kîɛɛɛr & {kîiir} & kîɛr\\
A & B & A & raised (2A) & ‘back’ & ɟɔ̀k & ɟɔ̂ak & {ɟɔ̂k} & ɟó̤ok\\
B & B & A & B & ‘home’ & cjêeŋ & cjêŋ & {cjé̤ŋ}  & cjêeeŋ\\
B & B  & (A) & raised (2A) & ‘pitcher’ & lîɛɛɛr & \multicolumn{2}{c}{lîɛr} & lí̤eeer-ì\\
\midrule
\multicolumn{9}{l}{Basic plurals}\\
\midrule
B & B & A & A & ‘hip joint’ & ɟûɔɔɔl & \multicolumn{2}{c}{ɟûɔl} & {ɟûl}\\
raised (2A) & B & (A) & A & ‘excrement’ & cé̤t̪ & \multicolumn{2}{c}{cɛ̤̀at̪} & {cɛ̌t̪}\\
\lspbottomrule
\end{tabular}
}
...
\begin{table}
P= plosive; F = voiceless continuant; S = suffixed form
\begin{tabularx}{\textwidth}{lllXlll}
\lsptoprule
