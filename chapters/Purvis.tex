...
%%\includegraphics[width=\textwidth]{PurvisACAL47HausaChatarticleadjustedfinal-img1.png}

 
%%please move the includegraphics inside the {figure} environment
%%\includegraphics[width=\textwidth]{PurvisACAL47HausaChatarticleadjustedfinal-img2.png}
...
Mother Tongue: & \ili{Hausa} (27), Fulfulde (16), \ili{Kanuri} (6), \ili{Yoruba} (1), Margi (1) , \ili{Nupe} (1), Other: 5\\
Language spoken at home: & \ili{Hausa} (45), Fulfulde (9), \ili{English} (1), \ili{Yoruba} (1), \ili{Kanuri} (2)\\
...
\lsptoprule
 Word & \multicolumn{1}{c}{Target uses} &  \multicolumn{1}{r}{Used as jargon in Hausa}\\
\midrule
...
\textit{tana} (in \textit{tana on}) & \textit{pers./asp.} 3\textsuperscript{rd} pers. sing. \isi{feminine} imperfective\\
