...
As \ili{Namibian Yeyi} has fewer \isi{click} types than Botswana \ili{Yeyi}, it has merged certain \isi{click} types: examples (\ref{ex:sands:3}-\ref{ex:sands:3} show that both palatal and dental clicks in Botswana \ili{Yeyi} correspond to dental clicks in \ili{Namibian Yeyi}. 
