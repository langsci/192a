...
\lsptoprule
Language & \isi{click} types & \isi{click} phonemes & percentage \mbox{of lexicon} & percentage of basic lexicon&\\
\midrule
...
As \ili{Namibian Yeyi} has fewer \isi{click} types than Botswana \ili{Yeyi}, it has merged certain \isi{click} types: examples (3)-(4) shows that both palatal and dental clicks in Botswana \ili{Yeyi} correspond to dental clicks in \ili{Namibian Yeyi}. 

\begin{itemize}
\item  
\textit{kù-ǀ}\textit{hàkà}     Botswana \ili{Yeyi} \\
\textit{kù-ǀ}\textit{hàkà}    \ili{Namibian Yeyi}\\
‘to chop’ (\citealt[10]{Lukusa2009}; \citealt[41]{Seidel2008})
 \item  
\textit{kù-í-ǂ}\textit{hòà}    Botswana \ili{Yeyi}\\
\textit{ku-i-ǀ}\textit{hoa}    \ili{Namibian Yeyi}\\
‘to slap’ (\citealt[41]{Seidel2008}; \citealt[34]{Sommer1992})
 \end{itemize}

Click loss, where clicks in Botswana \ili{Yeyi} correspond to non-clicks in \ili{Namibian Yeyi}, is also attested, as shown in example (5), which shows that a \isi{click} in Botswana \ili{Yeyi} can correspond to a non-\isi{click} velar in \ili{Namibian Yeyi}.

\begin{itemize}
\item  
\textit{kù-ì-ɡǃ}\textit{ámánì}    Botswana \ili{Yeyi}\\
\textit{kù-ì-khyàmínà}    \ili{Namibian Yeyi}\\
...
Clicks have not only spread from the core of the KBA to its fringe, but from the fringe to languages yet more geographically removed from the KBA, as shown in \figref{fig:sands:4}. The \isi{functional load} of clicks in \ili{Bantu} languages of eastern Zimbabwe, Mozambique and Malawi is low. They occur mainly in borrowings and ideophones. The \ili{Changana} variety of \ili{Tsonga} has three \isi{click} phonemes and 142 words with clicks \citep{Sitoe1996}. Other lects seem to have fewer \isi{click} words. Certain varieties of \ili{Karanga}, spoken in the Midlands of Zimbabwe, are reported to have a small number \isi{click} words, such as mùǀìrò ‘whip’, -ǀùb̤à ‘rinse mouth’ and mà-{\textbar}ìmb̤í ‘edible caterpillars’ \citep{Pongweni1990}, but the total number of words in the lexicon with clicks is unknown. 
...
In the \ili{Mzimba} variety of \ili{Tumbuka}, spoken in Malawi, clicks occur in certain place names. These clicks correspond to alveolar ejectives in the \ili{Nkhamanga} variety of \ili{Tumbuka}, which lacks clicks: the \ili{Mzimba} place name !aba is known as t’afa in \ili{Nkhamanga}, and the \ili{Mzimba} name Enguǀwini as Ngut’wini in \ili{Nkhamanga} \citep{Moyo1995}. 

In \ili{Ndau} as described by \citet{Borland1970}, certain words with clicks can be found, most of which are traceable to \ili{Zulu}, such as ku-ɡǁoka ‘wear clothes’ \citep[32]{Borland1970}, from \ili{Zulu} -ɡǁoka ‘wear, put on’ \citep[85]{Doke1958}. There is some instability in the pronunciation of clicks in \ili{Ndau}: lateral clicks alternate with dental and alveolar clicks, i.e. chi-ǀembo {\textasciitilde} chi-ǁembo ‘spoon’, or n!wadi {\textasciitilde} nǁwadi ‘book’. Clicks also alternate with velar non-clicks, i.e. chi-ɡǁoɡo {\textasciitilde} chi-ɡoɡo ‘hat’ \citep[30]{Borland1970}. Other descriptions of \ili{Ndau}, such as \citet{Doke1931}, do not mention clicks, suggesting either that they are recently acquired or only found in specific dialects. 
...
Bourquin, W. 1951. Click-words which \ili{Xhosa}, \ili{Zulu} and \ili{Sotho} have in common. African Studies. 59-81.


Fehn, Anne-Maria. forthcoming-a. Click loss in \ili{Khoe}-\ili{Kwadi}. In Sands, Bonny (ed.), The handbook of clicks. Leiden: Brill.

Fehn, Anne-Maria. forthcoming-b. Click replacement and loss in \ili{Ju}. In Sands, Bonny (ed.), The handbook of clicks. Leiden: Brill.


Güldemann, Tom. 2013. Typology. In Vossen, Rainer (ed.), The \ili{Khoesan} languages, 25-. London: Routledge.


Güldemann, Tom and Fehn, Anne-Maria. forthcoming. The Kalahari Basin Area as a 'Sprachbund' before the \ili{Bantu} expansion: an update. In Hickey, Raymond (ed.), The Cambridge handbook of areal linguistics. Cambridge: Cambridge University Press.

Gunnink, Hilde. to appear. Click loss and \isi{click} insertion in \ili{Fwe}. In Sands, Bonny (ed.), The handbook of clicks. Leiden: Brill.

Hunziker, Daniel A. and Hunziker, Elisabeth and Eaton, Helen. 2008. A description of the phonology of the \ili{Sandawe} language. Ms. SIL Electronic Working Papers (SILEWP) 2008-004. Available online: http://www.sil.org/resources/publications/entry/7875.

Idiatov, Dmitry and Van de Velde, Mark. 2016. The \isi{lexical frequency} of labial-velar stops in northern sub-Saharan Africa and its historical implications. (Paper presented at the Special Workshop on Areal Features and Linguistic Reconstruction, ACAL 47, Berkeley, 23-26  March 2016.)


Naumann, Christfried and Bibiko, Hans-Jörg. 2015. Southern Africa as a phonological area. (Paper presented at ``Speaking (of) \ili{Khoisan}'', a Symposium Reviewing Southern African Prehistory, Leipzig, 14-16 May 2015.)


Sands, Bonny. 2014. Adoption, maintenance and loss of \isi{click} contrasts. (Paper presented at ‘Sound Change in Interacting Human Systems’, 3rd Biennial Workshop on Sound Change, University of California, Berkeley, May 28-31, 2014. Available online: http://linguistics.berkeley.edu/SCIHS/abstracts/5\_FridayAfternoon/Sands.pdf


Schulz, Stephan and Laine, Antti. 2016. Click loss, variation and acquisition in two South African \ili{Ndebele} varieties. (Paper presented at the 46th Colloquium on African Languages and Linguistics, Leiden, 29-31 August 2016.)
