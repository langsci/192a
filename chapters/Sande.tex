...
\ex {AdvV}\\
\gll {e}$^{4}$ {ji}$^{3}$ \textbf{{fafa}$^{4.4}$} {Ɉa}$^{31}$ \textbf{{li}$^{3}$} \\
...
\gll {e}$^{4}$ {ji}$^{3}$ [ {Ɉa}$^{31}$ {la}$^{2}$ {li-li-je}$^{3.2.2}$ ] {koci}$^{23.1}$ \\
...
\ea {Postpositions} \\
\gll {wúrú-ꜝú} \textbf{{tábàrí-ꜝí}} \textbf{{zúk{\`ɔ}}} \\
