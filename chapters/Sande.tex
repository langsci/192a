...
\ea \gll wúrú-ꜝú \textbf{\textsuperscript{!}{ná}} {ʃwó-ꜝó} \textbf{{ɲì mì}}  \\
{dog}-\textsc{def} \textsc{fut} meat-\textsc{def} eat\\
\glt `The dog will eat the meat.' \label{ex:7a:dafing}
\ex \gll {\^ɛː} ná {f{\`ɔ}} ká wúrú-ꜝú \textbf{\textsuperscript{!}{ná}} {ʃwó-ꜝó} \textbf{{ɲì mì}}  \\
...
\ea {Postpositions} \\
\gll {wúrú-ꜝú} \textbf{{tábàrí-\textsuperscript{!}í}} \textbf{{zúk{\`ɔ}}} \\
dog-\textsc{def} table-\textsc{def} under \\
\glt  `The dog is under the table.'  \label{ex:8a:dafing}
\ex {Gen-N}\\
\gll \textbf{{ʃíì}} káꜝá \textbf{{wúrú-\textsuperscript{!}ú}} \\
