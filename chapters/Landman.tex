...
\z
 ...
 Third, \textit{age} interacts scopally with other quantifiers, such as \isi{negation} and modals. Unlike bare nouns, \textit{age} permits both narrow- and wide-\isi{scope} existential interpretations with respect to \isi{negation}:\footnote{It is possible that the wide-\isi{scope} interpretation here is actually a definite interpretation; see the discussion of definite interpretations for \textit{age} below.}
