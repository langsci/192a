...
For instance, in 'bridge', 'father' and 'cutlass' have a long vowel sentence-finally (\textit{r\`a\`a}, \textit{t\=a\`a}, and \textit{d\'a\`a}) but a short vowel sentence-medially (\textit{r\`a}, \textit{t\=a}, and \textit{d\'a}).
