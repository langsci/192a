...
\ea[]{
\gll \`{A}-mà à-díá àdésì \textbf{à-ny\`{\textturnv}\ng}/*y\`{e}/*ǹd\`{o}/*\`{m}m\`{e} à-\ng w\'ɔ\ng~ úk\'ɔtńs\`{\textturnv}\ng. \\
2{\SG}-{\PST} 2{\SG}-eat rice 2{\SG}-and 2{\SG}-drink palmwine \\
\glt `You ate rice and drank palmwine.'
}
\ex[]{
\gll \`{I}má á-kpón \textbf{á-ny\'{\textturnv}\ng}/*y\`{e}/*ǹd\`{o}/*\`{m}m\`{e} á-yáíyá. \\
...
\gll \'{I}nêm á-m\v{a}-k\`{o}p \textbf{á-ny\'{\textturnv}\ng} á-dí. \\
...
\ex[]{
\gll \'{I}nêm \textbf{á-mà} á-k\`{o}p \textbf{á-mà} \textbf{á-ny\'{\textturnv}\ng} á-dí.\\
...
\noindent The SVC in (\ref{ex:duncan-et-al:5}a) is thus ungrammatical if the second \isi{tense marker} is added. \textit{Ny\'{\textturnv}\ng} clauses, though, may contain more than one \isi{tense marker}, depending on the number of conjuncts involved. In (\ref{ex:duncan-et-al:5}b), the past \isi{tense marker} \textit{mà} appears twice, once in the first conjunct and once in the second.
...
\ea[*]{
\gll \`{O}k\^{o}n á-mà á-dùw\'ɔ \`{A}kpán á-d\'{\textturnv}k àdùb\`{e}. \\ 
Okon 3{\SG-\PST} 3{\SG}-fall Akpan 3{\SG}-enter pit \\
\glt (Intended: `Okon fell (and) Akpan entered a pit.')
}
\ex[]{
\gll \`{E}n\`ɔ á-mà á-ká store \textbf{á-ny\'{\textturnv}\ng} \'{I}má á-mà á-dép ǹw\`{e}t.\\
...
\ea[*]{
%\langinfo{Ibibio}{Niger-Congo}{personal knowledge}\\
\gll \'{I}má á-kpón \textbf{á-ny\`ɔ\'ɔ-ny\^{\textturnv}\ng} á-yàìyá. \\
...
\ex[]{
\gll \'{E}kpê á-mà á-tóp ítíyát \textbf{á-ny\'{\textturnv}\ng} á-ń-t\'ɔ.\\
...
\ea[]{
\gll \'{A}-mà á-díá àdésì \textbf{á-ny\'{\textturnv}\ng} á-\ng w\'ɔ\ng~ úk\'ɔtńs\`{\textturnv}\ng.\\
...
\ex[*]{
\gll \`{N}s\v{o} ké á-ké-díá àdésì \textbf{á-ny\'{\textturnv}\ng} á-\ng w\'ɔ\ng? \\
...
\ea[*]{
\gll \ldots \'{m}-f\'ɔp ùnàm \textbf{ǹ-ny\'{\textturnv}\ng} \textbf{ǹ-ny\'{\textturnv}\ng}. \\
...
\ea[]{
\gll \'{M}-mà á-kót úy\`{o} \`{m}f\`{o} \textbf{ń-ny\'{\textturnv}\ng} \textbf{ń-s\'ɔp} ń-dí. \\
1{\SG-\PST} 3{\SG}-hear voice your 1{\SG}-and 1{\SG}-do.quickly 1{\SG}-come \\
\glt `I heard your voice and came quickly.'
}
\ex[*]{
\gll \'{M}-mà á-kót úy\`{o} \`{m}f\`{o} \textbf{ń-s\'ɔp} \textbf{ń-ny\'{\textturnv}\ng} ń-dí. \\
...
\ea[]{
\gll \ldots \'{m}-mà \textbf{ń-sé} \textbf{ń-ny\'{\textturnv}\ng} ń-tímmé ń-k\`{e}né \'{m}-f\'ɔp ùnàm.\\
...
\ex[]{
\gll \'{N}-kpá ń-ké ń-sé ń-kóót ǹw\`{e}t (ń-kpá ń-ké) \textbf{ń-ny\'{\textturnv}\ng} \textbf{ń-sé} \'{m}-br\v{e} \`{m}-br\v{e}\ldots \\
...
\gll \ldots ń-kpé ń-ké \textbf{í-ny\'{\textturnv}\ng-\ng \'ɔ} \textbf{ń-sé} \'{m}-br\v{e} \`{m}-br\v{e}. \\
...
\fittable{
 \begin{tabularx}{\textwidth}{Xcccc} % add l for every additional column or remove as necessary
  \lsptoprule
...
%In addition to \textit{ny\'{\textturnv}\ng}, \ili{Ibibio} has two other (ad)verb-like elements---\textit{tímmé} `do again' and \textit{k\`{e}né} `emulate'---which bear distributional and semantic affinity to \textit{ny\'{\textturnv}\ng}. In this section, we discuss some of the properties of these elements to offer a more rounded discussion of what \textit{ny\'{\textturnv}\ng} may be.
...
%}
%\ex[]{
%\gll \'{E}kpê á-mà á-bárá ìká\ng~ \textbf{á-k\`{e}né} á-f\'ɔp ùnàm.\\
...
%Nevertheless, several key morphosyntactic features distinguish \textit{ny\'{\textturnv}\ng} from \textit{tímmé} and \textit{k\`{e}né}. The order in (29), for example, is fixed. Whenever more than one of the three elements is present, they appear in accordance with the following hiearchy:

%\ea
%\textit{ny\'{\textturnv}\ng} >> \textit{tímmé} >> \textit{k\`{e}né}
%\z

%\noindent The fact that \textit{tímmé} and \textit{k\`{e}né} follow---and thus presumably appear lower than---\textit{ny\'{\textturnv}\ng} is significant because it suggests that they do not occupy or compete for the same clausal position. 
...
%\begin{table}
%\caption{Properties of \textit{tímmé} and \textit{k\`{e}né} compared to \textit{ny\'{\textturnv}\ng}.}
