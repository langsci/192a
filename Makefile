...
main.snd: main.bbl
	...
	sed -i s/.*Centre.*// main.adx #remove titles which biblatex puts into the name index
	sed -i s/.*Bureau.*// main.adx #remove titles which biblatex puts into the name index
